...
VALUES ('Admin@mail.ru', 'Admin', '$2a$10$7bXkLy8dosKAibaHY2.9cOk5l9.ODFj7LwqKRqGdQKCs4Im1iwVXG');            -- SQLINES DEMO ***                                                -- 100 000

INSERT INTO users (USERNAME, FULL_NAME, PASSWORD)
VALUES ('User@mail.ru', 'User', '$2a$10$9Mt/IEWzMB9tQ0myxb0PZ.4GIdNg5EfeJsV.RZ1XYkR1zigXlQEvq');        -- SQLINES DEMO ***                                       -- 100 001
...
VALUES (100001, current_timestamp - 7, 0);                                          -- 100 020

INSERT INTO orders (USER_ID, CREATED, STATUS)
VALUES (100001, current_timestamp - 5, 1);                                          -- 100 021

INSERT INTO orders (USER_ID, CREATED, STATUS)
VALUES (100001, current_timestamp - 66, 1);                                         -- 100 022
